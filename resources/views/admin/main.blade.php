...
<head>
    ...
    <title>{{config('')}}Admin - Miyoshi Laundry & Dry Cleaning</title>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/input-transaksi')}}" class="nav-link {{(request()->is('admin/input-transaksi')) ? 'active' : ''}}">
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/harga')}}" class="nav-link {{(request()->is('admin/harga')) ? 'active' : ''}}">
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/saran')}}" class="nav-link {{(request()->is('admin/saran')) ? 'active' : ''}}">
